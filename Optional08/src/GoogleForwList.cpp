/**********************************************
* File: GoogleMulForwList.cpp
* Author: Matthew Morrison
* Email: matt.morrison@nd.edu
* 
* This is a solution to the Google License Interview question 
* using std::forward_list to store the dictionary words 
* 
* Compilation command: g++ -g -std=c++11 -Wpedantic GoogleMulForwList.cpp -o GoogleMulForwList
* Run: ./GoogleMulForwList [DictionaryFile]
* Example: ./GoogleMulForwList words.txt
**********************************************/
#include <iostream>
#include <fstream>
#include <vector>
...
* Post-conditions: none
*  
* This function reads all the dictionary words, and stores them in a STL Singly Linked List 
********************************************/
...
void checkPlate(std::forward_list< std::string >& dictionaryList, char* plateStr){
...
int main(int argc, char** argv){
	...
	// Create a Singly Linked list of dictionary words 
	...
	if(argc == 2){
		...
		std::cout << "./GoogleForwList [DictionaryFile]" << std::endl;
		exit(-1);
	}
