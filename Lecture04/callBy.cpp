...
int main(){
	...
	std::cout << "Before the method calls: \n";
	std::cout << "Address of tempX and tempX: \t\t " << &tempX << " " << &tempY << "\n";
	std::cout << "Values in tempX and tempX: \t\t " << tempX << " " << tempY << "\n";
	std::cout << "Address of ptrX and ptrY: \t\t " << &ptrX << " " << &ptrY << "\n";
	std::cout << "Values in ptrX and ptrY: \t\t " << ptrX << " " << ptrY << "\n\n";
