...
int main(){
	...
	// Print both the bTree3's child pointer address
	COUT << "bTree3 childPtrs[0] address  = " << (void *)(bTree3.childPtrs[0]) << ENDL;
	
	// ... as well as the nodePtr's child pointer address
	COUT << "nodePtr childPtrs[0] address = " << (void *)(nodePtr->childPtrs[0]) << ENDL << ENDL;
